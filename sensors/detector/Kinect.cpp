...
Kinect::loop()
{
	while (!xnOSWasKeyboardHit()) {
		...
		for (XnUInt16 i = 0; i < numUsers; ++i) {
			...
			mLink->setPosition(userBuf[i], torso.position.position.X,
											torso.position.position.Y,
