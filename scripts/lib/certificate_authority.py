...
def make_ca_directory_structure():
    make_directory("CA")
    with change_directory("CA"):
        make_sub_ca_directory_structure("root")
        write_ca_configuration(cert_dir="root", name="ca", policy="policy_strict")

        make_sub_ca_directory_structure("intermediate")
        write_ca_configuration(cert_dir="intermediate", name="intermediate", policy="policy_loose")


def make_sub_ca_directory_structure(root: str):
    assert "/" not in root
    make_directory(root)
...
def write_ca_configuration(**params):
