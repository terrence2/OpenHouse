...
import argparse
import os
from lib.certificate_authority import make_server_certificate
...
def main():
    ...
    make_server_certificate(args.name, key_size=4096, expire=100*365, key_security='', x509_security='-nodes')
